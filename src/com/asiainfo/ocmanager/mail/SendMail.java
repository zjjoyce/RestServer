...
public class SendMail {
    ...
    /**
     * Send email using Asiainfo SMTP server.
     *
     * @param username Asiainfo username
     * @param password Asiainfo password
    ...
    public static void Send(final String username, final String password, String recipientEmail, String ccEmail, String title, String message) throws AddressException, MessagingException {
        ...
        */
        ...
        msg.setFrom(new InternetAddress(username + "@asiainfo.com"));
    ...
    public static void main(String[] args){
        ...
        try {
            send.Send(username, passwd, recipientEmail, title, message);
